...
const WA_MSG = encodeURIComponent("Hi Nordic! I'd like to book a weight loss session at home in Dubai.");
    ...
    <section className="py-20 bg-white">
      <div className="px-8 sm:px-12 lg:px-16">
        {/* <FadeIn className="mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">Our Weight Loss Services</h2>
          <p className="text-gray-400 text-sm mt-2">Expert weight loss programs delivered at home by DHA-licensed professionals across Dubai.</p>
        </FadeIn> */}
    ...
    <div className="bg-[#F7F4EE] min-h-screen font-sans">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-[#1a2e28]">
        <div className="absolute inset-0">
          <Image src="/images/weight-loss.jpeg" alt="Weight Loss Programs at Home Dubai" fill sizes="100vw" className="object-cover object-center" priority />
          ...
          <div className="lg:grid lg:grid-cols-[1fr_1fr] lg:gap-16 items-center">
            <div>
              <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-5">
                <span className="inline-flex items-center gap-2 bg-[#543826]/15 border border-[#543826]/20 text-[#C9C3B3] text-[11px] font-semibold uppercase tracking-[0.15em] px-4 py-2 rounded-full">
                  ...
                  Weight Loss at Home · Dubai · DHA-Licensed
                </span>
              </motion.div>
              ...
              <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }} className="font-bold text-white leading-[1.1] mb-4" style={{ fontSize: "clamp(36px, 5vw, 60px)" }}>
                Dubai's Trusted<br />At-Home Weight Loss Programs
              </motion.h1>
              ...
              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="text-white/70 text-base leading-relaxed mb-8 max-w-md">
                Doctor-supervised weight loss treatments delivered to your doorstep by DHA-licensed professionals across Dubai. Achieve your goals with convenient same-day appointments.
              </motion.p>
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.4 }} className="hidden lg:block">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl" style={{ minHeight: "480px" }}>
                <Image src="/images/weight-loss.jpeg" alt="Weight Loss program at home" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover object-center" />
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl px-5 py-4">
                    <p className="text-white font-semibold text-sm">Starting from AED 299</p>
      ...
      <section className="bg-[#F7F4EE] py-16 px-6">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="space-y-2">
            {[
              { q: "What is at-home weight loss treatment?", a: "Our weight loss programs include doctor-supervised treatments such as lipotropic injections, appetite-control programs, and metabolic boosters — all delivered at your home by DHA-licensed professionals." },
              { q: "Is weight loss treatment safe at home?", a: "Absolutely. All sessions are administered by DHA-licensed nurses and supervised by doctors with sterile, medical-grade equipment. Your vitals are monitored throughout." },
              { q: "How long does a weight loss session take?", a: "Most sessions take 30–60 minutes depending on the treatment type. The professional stays with you the entire time to monitor comfort and progress." },
              { q: "Do I need a prescription?", a: "Our visiting doctor can assess your needs and recommend the right program. No prior prescription is required for initial consultations." },
              { q: "What areas in Dubai do you cover?", a: "We cover all Dubai areas — Marina, Downtown, JBR, Palm Jumeirah, DIFC, Business Bay, JLT, and more. A professional arrives at your door at your scheduled time." },
              { q: "How much does weight loss treatment cost?", a: "Prices vary by program type. Visit our services section above for transparent pricing, or message us on WhatsApp for a personalised recommendation." },
              { q: "Can I book same-day?", a: "Yes. Most bookings are confirmed within 15 minutes and a professional can arrive within 60 minutes for urgent requests." },
              { q: "What weight loss programs are available?", a: "We offer Lipotropic Injections, Appetite Control, Metabolic Boosters, Body Contouring, and custom programs based on your specific health goals." },
        ...
        <div className="max-w-[860px] mx-auto">
          <div className="bg-white rounded-3xl px-8 sm:px-16 py-12 text-center shadow-sm border border-black/5">
            <div className="inline-flex items-center gap-2 mb-5">
              ...
              <span className="text-[#543826] text-xs font-semibold">DHA-licensed professionals · All Dubai · At your doorstep</span>
            </div>
            <h2 className="font-bold text-[#1a2e28] mb-4" style={{ fontSize: "clamp(22px, 3vw, 38px)" }}>Book your weight loss session at home today.</h2>
            <p className="text-[#6B7280] text-sm mb-7 max-w-sm mx-auto">No clinic. No waiting. A DHA-licensed professional arrives at your door with everything needed for your session.</p>
