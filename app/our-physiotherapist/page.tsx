...
export const metadata: Metadata = {
  title: "Our Physiotherapist | Nordic Home Healthcare",
  description:
...
const NURSES: NurseListing[] = [
  {
    slug: "tania-jennifer",
    name: "Tania Jennifer",
    title: "Doctor of Physical Therapy · DHA Licensed Physiotherapist",
    photo: "/images/tania-jennifer.jpg",
    bio: "Tania brings hospital-grade rehabilitation into the comfort of the home — combining musculoskeletal, orthopedic and postpartum expertise with the calm, unhurried pace that home-based care makes possible.",
  },
];
  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <nav className="max-w-6xl mx-auto px-6 pt-32 lg:pt-36 pb-2 flex items-center flex-wrap gap-x-2 gap-y-1 text-sm text-gray-500">
        ...
        <span>/</span>
        <span className="text-[#543826] font-medium">Our Physiotherapist</span>
      </nav>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-8 pb-4">
        ...
        <h1 className="font-brand text-3xl md:text-4xl font-bold text-[#543826] mt-2 mb-3">Our Physiotherapist</h1>
        <p className="text-[15px] text-gray-600 max-w-2xl">
          Meet the DHA-licensed nurses and clinicians who deliver Nordic&apos;s home healthcare across Dubai — tap a
          profile to see their full background, credentials and areas of care.
        </p>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8">
        <div className="flex flex-col gap-5">
          {NURSES.map((nurse) => (
            <Link
              key={nurse.slug}
              href={`/our-physiotherapist/${nurse.slug}`}
