...
const FAQS = [
  { q: "What is IV Glutathione therapy?", a: "IV Glutathione is a potent antioxidant infusion delivered directly into your bloodstream for maximum absorption. It helps lighten skin, detoxify the liver, boost immunity, and increase energy levels." },
  { q: "How many sessions do I need to see results?", a: "Most clients see visible skin brightening after 4–6 sessions. For maintenance, a monthly session is recommended. Your nurse will create a personalized plan." },
  { q: "Is IV Glutathione safe?", a: "Yes, when administered by a DHA-licensed nurse in a sterile environment. Nordic follows strict medical protocols for every session." },
  { q: "Are there any side effects?", a: "Side effects are rare but may include mild nausea, dizziness, or a metallic taste during the drip. These typically subside quickly after the session." },
  { q: "How long does a session take?", a: "Each session takes approximately 30–60 minutes. The nurse stays with you throughout." },
  { q: "Can I get IV Glutathione at home?", a: "Yes! A DHA-licensed Nordic nurse visits your home anywhere in Dubai with all the equipment needed." },
];
